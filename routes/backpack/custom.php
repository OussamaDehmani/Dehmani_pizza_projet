...
Route::group([
    ...
    Route::crud('commande_formule', 'Commande_formuleCrudController');
    Route::crud('commande_produit', 'Commande_produitCrudController');
    Route::crud('commande_suplement', 'Commande_suplementCrudController');
